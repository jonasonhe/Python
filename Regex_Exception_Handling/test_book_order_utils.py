...
class TestBookOrderDetails(TestCase):
    ...
    def test_validate_book_errors(self):
        ...
        self.assertRaisesRegex(TypeError,
                               ...
                               book_order_utils.validate_book_order_details,
                               "1", "Data Science", "Sally Lee", "1234", "1900", "A", "0.00")
    ...
    def test_valid_book_unit_cost(self):
        """ Tests valid inputs to calculate_per_book_cost """

        result1 = book_order_utils.calculate_per_book_cost(100.0, 10)
        self.assertEqual(10.0, result1)

        result2 = book_order_utils.calculate_per_book_cost(101.0, 5)
        self.assertEqual(20.2, result2)

        result3 = book_order_utils.calculate_per_book_cost(999.99, 9)
        self.assertEqual(111.11, result3)

        TestBookOrderDetails.grade += 1

    def test_invalid_book_unit_cost(self):
        """ Tests valid inputs to calculate_per_book_cost """

        self.assertRaisesRegex(ZeroDivisionError, "float division by zero",
                               book_order_utils.calculate_per_book_cost, 100.0, 0)
    ...
    def test_write_book_order_details(self):
        ...
        self.assertRaisesRegex(ValueError, "Order file name already exists!",
                               ...
                               "test.txt", "0001", "Intro to Python", "Bill Smith", "12345", "2000", "10", "100.45", 10.045)
